...
import { Bot, Search, TrendingUp, ShoppingBag, Check, ArrowRight } from 'lucide-react';
  ...
  const ServiceBlock = ({ 
    ...
    <div className={`p-10 md:p-14 border ${isPrimary ? 'border-neutral-800 bg-neutral-900 text-white' : 'border-neutral-900 bg-neutral-950 text-white'} hover:border-neutral-700 transition-all duration-500`}>
      <div className="flex items-center gap-6 mb-8">
        <Icon size={32} strokeWidth={1} className={isPrimary ? "text-white" : "text-white"} />
      ...
      {isPrimary && (
          <div className="mt-10 pt-8 border-t border-neutral-700">
             <Link to="/contact" className="inline-flex items-center text-sm font-bold uppercase tracking-wider hover:text-neutral-300 transition-colors">
