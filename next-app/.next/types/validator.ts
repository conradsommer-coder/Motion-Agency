...
// Validate ../../app/(site)/motion-designs/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/motion-designs">> = Specific
  const handler = {} as typeof import("../../app/(site)/motion-designs/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
