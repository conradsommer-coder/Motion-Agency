    ...
    <div className="space-y-12">
      {post.content.map((block, idx) => {
        ...
        if (block.type === 'quote') return (
          <blockquote key={idx} className="border-l-2 border-white pl-8 py-2 my-12 text-2xl md:text-3xl font-serif italic text-neutral-200 leading-tight">
        ...
        <div className="h-[70vh] relative w-full overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 w-full p-6 md:p-12">
            <div className="max-w-[1400px] mx-auto">
              <Link href="/blog" className="inline-flex items-center gap-2 text-white/70 hover:text-white mb-8 text-xs font-bold uppercase tracking-widest">
  ...
  return (
    <div className="bg-neutral-950 min-h-screen pt-40 pb-32 px-6">
      <div className="max-w-3xl mx-auto">
        <Link href="/blog" className="inline-flex items-center gap-2 text-neutral-500 hover:text-white mb-12 text-xs font-bold uppercase tracking-widest">
