...
export default function MotionDesignsPage() {
  ...
  return (
    <div className="w-full bg-neutral-950">
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
            ...
            >
              ...
              <p className="text-2xl text-neutral-400 font-serif italic mb-8">&ldquo;{t.motionDesigns.branding.subtitle}&rdquo;</p>
      ...
      {/* Section 2: Real Estate Developers */}
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            ...
            >
              ...
              <p className="text-2xl text-neutral-400 font-serif italic mb-8">&ldquo;{t.motionDesigns.realEstate.subtitle}&rdquo;</p>
              ...
              <Link
                href="/contact"
                className="inline-flex items-center gap-3 px-8 py-4 bg-white text-black font-bold uppercase tracking-wider text-sm hover:bg-neutral-200 transition-colors"
              >
